...
protected:
	...
	virtual void ClientSetFixedGravityDirection(const FVector& NewFixedGravityDirection);
...
protected:
	 ...
	 */
	UFUNCTION(Client,Reliable)
	virtual void ClientSetSplineTangentGravityDirection(AActor* NewGravityActor);
...
protected:
	 ...
	 */
	UFUNCTION(Client,Reliable)
	virtual void ClientSetPointGravityDirection(const FVector& NewGravityPoint);
	 ...
	 */
	UFUNCTION(Client,Reliable)
	virtual void ClientSetPointGravityDirectionFromActor(AActor* NewGravityActor);
...
protected:
	 ...
	 */
	UFUNCTION(Client,Reliable)
	virtual void ClientSetLineGravityDirection(const FVector& NewGravityLineStart, const FVector& NewGravityLineEnd);
...
protected:
	 ...
	 */
	UFUNCTION(Client,Reliable)
	virtual void ClientSetSegmentGravityDirection(const FVector& NewGravitySegmentStart, const FVector& NewGravitySegmentEnd);
...
protected:
	 ...
	 */
	UFUNCTION(Client,Reliable)
	virtual void ClientSetSplineGravityDirection(AActor* NewGravityActor);
...
protected:
	 ...
	 */
	UFUNCTION(Client,Reliable)
	virtual void ClientSetPlaneGravityDirection(const FVector& NewGravityPlaneBase, const FVector& NewGravityPlaneNormal);
...
protected:
	 ...
	 */
	UFUNCTION(Client,Reliable)
	virtual void ClientSetSplinePlaneGravityDirection(AActor* NewGravityActor);
...
protected:
	 ...
	 */
	UFUNCTION(Client,Reliable)
	virtual void ClientSetBoxGravityDirection(const FVector& NewGravityBoxOrigin, const FVector& NewGravityBoxExtent);
	 ...
	 */
	UFUNCTION(Client,Reliable)
	virtual void ClientSetBoxGravityDirectionFromActor(AActor* NewGravityActor);
...
protected:
	 ...
	 */
	UFUNCTION(Client,Reliable)
	virtual void ClientSetCollisionGravityDirection(AActor* NewGravityActor);
...
protected:
	 ...
	 */
	UFUNCTION(Client,Reliable)
	virtual void ClientEnableAlignGravityToBase();

	/**
	 * Disables bAlignGravityToBase flag for clients.
	 */
	UFUNCTION(Client,Reliable)
	virtual void ClientDisableAlignGravityToBase();
...
public:
	...
	{
		const FRotator ComponentRotator = UpdatedComponent->GetComponentRotation();
		if (FMath::IsNearlyZero(ComponentRotator.Pitch, SCENECOMPONENT_ROTATOR_TOLERANCE * 100.0f) &&
			FMath::IsNearlyZero(ComponentRotator.Roll, SCENECOMPONENT_ROTATOR_TOLERANCE * 100.0f))
		{
			// Avoids usage of several complex calculations in other places
...
protected:
	 ...
	 */
	UFUNCTION(Client,Reliable)
	virtual void ClientEnableAlignComponentToFloor();

	/**
	 * Disables bAlignComponentToFloor flag for clients.
	 */
	UFUNCTION(Client,Reliable)
	virtual void ClientDisableAlignComponentToFloor();
...
protected:
	 ...
	 */
	UFUNCTION(Client,Reliable)
	virtual void ClientEnableAlignComponentToGravity();

	/**
	 * Disables bAlignComponentToGravity flag for clients.
	 */
	UFUNCTION(Client,Reliable)
	virtual void ClientDisableAlignComponentToGravity();
...
public:
	 ...
	 */
	virtual void UpdateComponentRotation(bool bRotateAroundCenter, bool bRotateVelocity);
};
